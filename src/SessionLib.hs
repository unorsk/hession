...
fromHex hexString = undefined

sessionGenerateKeyPair :: ByteArray -> IO SessionKeyPair
sessionGenerateKeyPair seed = undefined
...
-- signInByLinkingDevice :: Mnemonic -> IO Bool
-- signInByLinkingDevice mnemonic =
